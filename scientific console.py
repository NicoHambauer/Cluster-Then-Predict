...
hpo_grid = pd.read_json('hpo_grids/classification_grid.json')
arg_dict = hpo_grid['IGANN']
...
model = Model('IGANN', 'regression', arg_dict, num_cols=data.numerical_cols, cat_cols=data.categorical_cols)
