...
preprocessor = ColumnTransformer(
    transformers=[
        ...
        ('cat', OneHotEncoder(sparse=False, handle_unknown='ignore', drop='if_binary'), categorical_cols)
    ])
...
with open('hpo_grids/default.json', "r") as read_file:
...
model = Model(model_name, problem, arg_dict, num_cols=numerical_cols, cat_cols=categorical_cols)
